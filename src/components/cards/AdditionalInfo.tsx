...
const FormatComponent = ({ value, number }: { value: string; number: number }) => {
  if (value === "sunrise" || value === "sunset") {
    return new Date(number * 1000).toLocaleTimeString(undefined, { hour: "numeric", minute: "2-digit", hour12: true });
  }
  if (value === "wind_deg") {
    return (
      <UpArrow
