...
export const MapLegend = ({ mapType }: MapLegendProps) => {
  ...
  return (
    <div className="absolute top-4 right-4 z-1000 w-48 500:w-96 rounded-xl shadow-lg p-4 bg-background/50 border-accent/70 flex flex-col gap-3">
